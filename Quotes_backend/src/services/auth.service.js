...
export async function registerUser({ username, email, password, role, gender, bio }) {
...
export async function loginUser({ email, password }) {
  ...
  const token = jwt.sign(
    { sub: String(user._id), username: user.username, email: user.email, bio: user.bio, gender: user.gender },
    JWT_SECRET,
