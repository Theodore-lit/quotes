  ...
  <div class="bg-gray-100 min-h-screen py-12">
    <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
      ...
      <div class="space-y-6">
            ...
            <div class="px-4 py-5 sm:p-6">
              <div class="flex justify-between items-start">
                ...
                <div class="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button @click="editQuote(quote._id)" class="p-1 text-blue-600 hover:bg-blue-50 rounded">
                  ...
                  <button @click="deleteQuote(quote._id)" class="p-1 text-red-600 hover:bg-red-50 rounded">
                    <svg xmlns="http://www.w3.org" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
        ...
        <!-- Cas vide -->
        <div v-else class="text-center py-20 bg-white rounded-lg shadow border-2 border-dashed border-gray-200">
          <p class="text-gray-500">Vous n'avez pas encore publié de citations.</p>
          <button @click="router.push({name: 'add-quote'})" class="mt-4 text-indigo-600 font-bold hover:underline">
