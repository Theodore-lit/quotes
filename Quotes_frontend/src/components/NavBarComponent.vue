...
<template>
  <nav class="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-50">
        ...
        <div class="flex items-center gap-2">
          ...
          <div  class="hidden md:flex items-center gap-4">
            <template v-if="loginStore.token && decoded">
              ...
              >
                <div
                  class="h-6 w-6 rounded-full bg-indigo-600 text-white flex items-center justify-center text-[10px] uppercase font-bold"
                >
    ...
    <div  v-if="loginStore.token"  v-show="isMenuOpen" class="md:hidden border-t border-gray-100 bg-white">
