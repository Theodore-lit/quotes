...
<template>
      ...
      <div class="w-3/4 max-w-md p-8 bg-white shadow-lg rounded-lg">
        ...
        <form @submit.prevent="register">
          ...
          <div class="mb-4">
            ...
            <input type="password" name="password" placeholder="Enter your password" v-model="newUser.password"
              class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          ...
          <div class="mb-4">
            ...
            <input type="text" name="bio" placeholder="Enter your email" v-model="newUser.bio"
              class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          <div class="mb-4">
            <label class="block text-gray-700 text-sm mb-2">Bio</label>
  ...
  <!-- <template> -->
  <div class="card shadow-lg  rounded-2xl w-full p-10">
      ...
      <p class="text-gray-500 text-center py-3 text-2xl font-medium">Inscription</p>
      ...
      <StepPanels>
        <StepPanel :value="0">
          <div class="relative items-center flex w-full">
            <img :src="curImage" class="w-20 h-20 rounded-full object-cover border-2 border-gray-200 bg-gray-100"
              alt="Avatar" />
          </div>
